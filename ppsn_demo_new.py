...
from model.shapelet_discovery_new import ShapeletDiscover
...
def main(args):
        ...
        if epoch % args.sep == 0:
            ...
            with torch.no_grad():
                for b in range(len(testing_set_loader)):
                    ...
                    best_test_loss = loss.cpu()
                    best_test_accuracy = correct.cpu()
    log.flush() 
    ...
    with open(f"result_train1/{args.dataset_name}_result_new.txt", "w") as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--r", default=3, type=int, help="Number of r")
    parser.add_argument("--subset_ratio", default=0.2, type=int, help="Number of r")
